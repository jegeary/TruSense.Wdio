exports.config = {
    ...
    //
    specs: [
    // './dist/src/web/specs/*/*.spec.js',
    //  './dist/src/web/specs/*/*/*.spec.js',
        './dist/src/web/specs/*/*/*/account-settings.spec.js',    ],
    // Patterns to exclude.
    exclude: [
    ...
    baseUrl: 'https://app-staging.mytrusense.com',
    //
    ...
    beforeSession: function (config, capabilities, specs) {
        thisConfig = JSON.stringify(config);
        thisCaps = JSON.stringify(capabilities);
        thisSpec = JSON.stringify(specs);
        console.log('CONFIG:' + '\n');
        console.log('*****************' + '\n');
        console.log(thisConfig + '\n');
        console.log('CAPS:' + '\n');
        console.log('*****************' + '\n');
        console.log(thisCaps + '\n');
        console.log('specs:' + '\n');
        console.log('*****************' + '\n');
